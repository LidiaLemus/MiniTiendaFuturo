    ...
    <nav class="navbar is-info is-left" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        <a class="navbar-item" href="{{route('home')}}">
          <img src="{{ asset('imagenes/logo.jpg') }}" width="200" height="500">
        </a>
              ...
              <div class="buttons">
                ...
                <div class="field">
                  <div class="control  has-icons-left">
                    <a class="button is-danger is-focused" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    </a>
