...
@section('content')
  ...
  <div class="field">
  <div class="control">
    <input class="input is-primary" type="text" name="email" placeholder="correo" required oninvalid="this.setCustomValidity('Por favor ingresa tu Correo Electronico')">
  </div>
  <div class="field">
  <div class="control">
  ...
  <div class="field">
  <div class="control">
    <input class="input is-primary" type="text" name="nit" placeholder="Nit" required oninvalid="this.setCustomValidity('Por favor ingresa tu el Nit')">
  </div>
  <br>
