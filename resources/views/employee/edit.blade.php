...
<div class="container">
  ...
  <div class=" field">
            ...
            <div class="field">
              <div class="control">
                <input class="input is-primary" type="text" name="email" placeholder="Correo Electronico"
                  value="{{$employee->email}}">
              </div>
            </div>
            <div class="field">
              <div class="control">
                <input class="input is-primary" type="text" name="cui" placeholder="Numero de CUI"
                  value="{{$employee->cui}}">
              </div>
            </div>
            <br>
