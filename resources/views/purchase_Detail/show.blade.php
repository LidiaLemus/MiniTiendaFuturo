	...
	<table class="table is-fullwidth is-striped is-hoverable">
		...
		<tbody>
			...
			<tr>
				...
				<td><a class="button is-success button is-fullwidth" href="{{route('purchase_Detail.index')}}">Lista de
						compras</a></td>
				<td><a class="button is-primary button is-fullwidth"
						href="{{route('purchase_Detail.edit',$purchase_Detail->id)}}">Editar</a></td>
